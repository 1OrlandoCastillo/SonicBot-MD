...
let modos = cargarModos();
    ...
    console.log(chalk.cyan(figlet.textSync("Sonic 2.0 Bot", { font: "Standard" })));    
...
try {
  ...
  if (citado && global.cachePlay10[citado]) {
    ...
    if (['1', 'audio', '3', 'musicadoc'].includes(texto)) {
      ...
      const res = await axios.get(`https://theadonix-api.vercel.app/api/ytmp3?query=${encodeURIComponent(data.videoUrl)}`);
